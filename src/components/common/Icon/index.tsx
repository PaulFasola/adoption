...
export const Icon: React.FC<IProps> = (props) => {
	const _outboundLink: React.ReactNode = (
	...
	const _arrowUp: React.ReactNode = (
		<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 330 330" xmlSpace="preserve">
	...
	const _arrowDown: React.ReactNode = (
	...
	const _helpCircle: React.ReactNode = (<svg viewBox="0 0 20 20">
				...
				<g transform="translate(100.000000, 100.000000)">
					<g transform="translate(680.000000, 186.000000)">
						<g>
							...
							<path className="fillable" d="M11,18 L13,18 L13,16 L11,16 L11,18 Z M12,2 C6.48,2 2,6.48 2,12 C2,17.52 6.48,22 12,22 C17.52,22 22,17.52 22,12 C22,6.48 17.52,2 12,2 Z M12,20 C7.59,20 4,16.41 4,12 C4,7.59 7.59,4 12,4 C16.41,4 20,7.59 20,12 C20,16.41 16.41,20 12,20 Z M12,6 C9.79,6 8,7.79 8,10 L10,10 C10,8.9 10.9,8 12,8 C13.1,8 14,8.9 14,10 C14,12 11,11.75 11,15 L13,15 C13,12.75 16,12.5 16,10 C16,7.79 14.21,6 12,6 Z"></path>
						</g>
					</g>
				</g>
			</g>
	...
	if (props.url) {
		return (<Link href={props.url} title={props.url} {..._getSpecProps()}>
